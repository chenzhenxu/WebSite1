<%@ Page Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" CodeFile="SiteInfo.aspx.cs" Inherits="Common_SiteInfo" Title="Untitled Page" EnableEventValidation="false"%>
    ...
    <table width="771" height="465" border="0" align="center" cellpadding="0" cellspacing="1" class="waikuang">
        <tr>
          ...
          <td valign="top"><table width="756" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="45" colspan="3" background=""><h4>网站信息</h4>&nbsp;</td>
            </tr>
            <tr>
              <td colspan="3" background="../images/tu shu pai hang2.gif"><table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="74" align="center" class="daohang1">网站名称：</td>
                  <td colspan="2"><label>
                ...
                <tr>
                  ...
                  <td height="28" align="center" class="daohang1">站长：</td>
                ...
                <tr>
                  ...
                  <td height="27" align="center" class="daohang1">建站时间：</td>
