<%@ Page Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" CodeFile="UpdateDocumentat.aspx.cs" Inherits="DocumentatManage_UpdateDocumentat" Title="Untitled Page" EnableEventValidation="false"%>
          ...
          <td valign="top"><table width="756" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td colspan="3" background="../images/tu shu pai hang2.gif"><table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td height="26" align="right" class="daohang1">&nbsp;</td>
                  <td height="26" align="center" class="daohang1">文件路径：</td>
                  <td colspan="3"> <asp:TextBox ID="TextPath" runat="server"></asp:TextBox></td>
                  <td align="center">&nbsp;</td>
                </tr>
                <tr>
