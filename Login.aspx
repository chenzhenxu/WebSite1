...
<div align="center">
  <table id="Table1" width="914" height="759" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr><form id="Form1" name="form1" method="post" action="" runat="server">
      <td height="249" valign="top" background="images/_denglu.gif"><h1>文献资料管理系统</h1><table width="777" border="0" cellspacing="0" cellpadding="0">
        <tr>
        ...
        <tr>
          ...
          <td colspan="3"><label>
            <asp:TextBox ID="Password" runat="server" Width="148px" TextMode="Password"></asp:TextBox>
              &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;</label></td>
        </tr>
        <tr>
          <td height="31">&nbsp;</td>
    ...
    <tr>
      <td height="66" background="images/index_//14.gif">&nbsp;</td>
    </tr>
    <tr>
